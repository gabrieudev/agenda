...
import br.com.gabrieudev.agenda.infrastructrure.web.dtos.role.CreateRoleDTO;
import br.com.gabrieudev.agenda.infrastructrure.web.dtos.role.RoleDTO;
import br.com.gabrieudev.agenda.infrastructrure.web.dtos.role.UpdateRoleDTO;
...
public class RoleController {
    ...
    public ResponseEntity<RoleDTO> getRoleById(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(RoleDTO.from(roleInteractor.findById(id)));
    }
